...
export async function POST(request: NextRequest) {
  try {
    ...
    const BROCHURES = `- Brochure Kunststofkozijnnodig.nl: https://drive.google.com/file/d/1eA1RR1Vn8M4UvYE5avS9IecRxfJ2Ucb_/view\n- Brochure Voordeuren: https://drive.google.com/file/d/1KArp4I9gKdUqQrGCehtrcYk-NUI89w85/view`

    const systemPrompt = `Je schrijft een zakelijke, vriendelijke e-mail namens Kunststofkozijnnodig.nl. Kunststofkozijnnodig.nl is een LEVERANCIER van hoogwaardige kunststof en aluminium kozijnen. Wij richten ons uitsluitend op aannemers, bouwbedrijven en timmerbedrijven die zelf inmeten en plaatsen — Kunststofkozijnnodig.nl doet dat NIET zelf. Dat houdt onze prijzen scherp.

Schrijf in correct Nederlands, to-the-point, niet te formeel. Stel jezelf NIET persoonlijk voor ('Ik ben ...'). Schrijf namens 'Kunststofkozijnnodig.nl'.
