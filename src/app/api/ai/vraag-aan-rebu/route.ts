...
// "AI-assistent" — AI-agent die natuurlijke-taal-vragen over je CRM
...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = `Je bent "AI-assistent" — een hulpzaam medewerkers-tool voor Kunststofkozijnnodig.nl. Je beantwoordt vragen over de CRM van Kunststofkozijnnodig.nl door beschikbare tools aan te roepen. Belangrijke regels:
