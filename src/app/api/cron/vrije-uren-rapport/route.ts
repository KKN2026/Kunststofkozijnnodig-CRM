...
<p style="color:#888;font-size:12px">Automatisch gegenereerd door het Kunststofkozijnnodig CRM.</p>`

  try {
    await sendEmail({
      to: ontvanger,
      subject: `Vrije uren ${maandNaam(maand)} ${jaar} — Kunststofkozijnnodig.nl`,
      html,
    })
  } catch (err) {
