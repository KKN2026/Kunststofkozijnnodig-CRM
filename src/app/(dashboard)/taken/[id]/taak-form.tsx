    ...
    <div>
      ...
      {trackerRelatie && (trackerRelatie.email || trackerRelatie.telefoon || trackerRelatie.contactpersoon) && (
        <div className="-mt-2 mb-4 flex flex-wrap items-center gap-x-5 gap-y-1 text-sm text-gray-600">
          <Link href={`/relatiebeheer/${trackerRelatie.id}`} className="font-medium text-gray-900 hover:text-[#1e40af]">
          ...
          {trackerRelatie.email && (
            <a href={`mailto:${trackerRelatie.email}`} className="inline-flex items-center gap-1.5 hover:text-[#1e40af]">
            ...
            <div className="flex gap-2 flex-wrap">
              {!isNew && (
                afgerondState ? (
                  ...
                  <Button type="button" onClick={handleToggleAfgerond} disabled={loading} className="bg-[#1e40af] hover:bg-[#1e3a8a] text-white">
            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
                <Link
                  ...
                  className="text-sm font-medium text-gray-900 hover:text-[#1e40af] inline-flex items-center gap-1"
                >
                  {offerteStatus.offertenummer}
                  <span className="text-gray-400 hover:text-[#1e40af]">→</span>
                </Link>
                  ...
                  {offerteEmails.map((e) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full text-left px-3 py-2 rounded-lg border border-gray-200 hover:border-[#1e40af] hover:bg-gray-50 transition-colors flex items-start gap-3"
                      >
            ...
            <CardContent className="pt-4 pb-3 space-y-3">
              ...
              {notitieText.trim() && (
                <div className="flex gap-2 justify-end">
                  ...
                  <Button type="button" size="sm" className="bg-[#1e40af] hover:bg-[#1e3a8a]" onClick={addPendingNotitie}>
              ...
              {!showVervolgTaak ? (
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1e40af] focus:border-transparent"
                  />
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex gap-2 ml-auto">
                      ...
                      <Button type="button" size="sm" className="bg-[#1e40af] hover:bg-[#1e3a8a]" onClick={handleCreateVervolgTaak} disabled={loading || !vervolgTitel.trim()}>
                ...
                {notities.map((n, i) => {
                  ...
                  return (
                    <div key={n.id} className="relative pl-10 py-3 group">
                      {/* Tijdlijn dot */}
                      <div className="absolute left-[11px] top-[18px] h-2.5 w-2.5 rounded-full border-2 border-[#1e40af] bg-white z-10" />
                        ...
                        {editNotitieId !== n.id && (
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                            <button
                              ...
                              className="p-1 text-gray-300 hover:text-[#1e40af]"
                              title="Bewerken"
                            >
