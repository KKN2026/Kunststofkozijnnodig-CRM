...
-- te passen. Wordt live verrekend tijdens het bewerken (stap-controleren) en
-- definitief vastgelegd bij opslaan in offerte_regels.totaal en
-- offertes.subtotaal/btw_totaal/totaal. Vanaf daar erven order_regels en
-- factuur_regels de al-verrekende waarde.
