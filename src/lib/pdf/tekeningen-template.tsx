...
export function TekeningenDocument({ offerte }: { offerte: TekeningenData }) {
  ...
  return (
    <Document>
      {/* ====== ELEMENT PAGINA'S (ZONDER PRIJZEN, geen Kunststofkozijnnodig.nl branding — klant zet er zelf offerte omheen) ====== */}
      ...
      {/* ====== SAMENVATTING (geen Kunststofkozijnnodig.nl branding — klant voegt eigen offerte toe) ====== */}
