                      ...
                      {toonMaand && (
                        <div className="px-2 pb-1.5 -mt-0.5 flex items-center gap-1" title="Verwachte valmaand — voedt de prognose">
                          ...
                          <input
                            ...
                            className={`w-full bg-transparent border-0 p-0 text-[10px] focus:outline-none focus:ring-1 focus:ring-[#1e40af] rounded cursor-pointer ${c.verwachteValmaand ? 'text-gray-600' : 'text-gray-400'}`}
                          />
                        </div>
                      )}
                    </div>
