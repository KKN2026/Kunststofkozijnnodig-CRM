...
export async function POST(request: NextRequest) {
  try {
    ...
    const {
      ...
      origineleTekst = '',
      klantNaam = '',
      medewerkerNaam = 'Kunststofkozijnnodig.nl',
      extraInstructie = '',
    ...
    const systemPrompt = `Je schrijft namens Kunststofkozijnnodig.nl. Kunststofkozijnnodig.nl is een LEVERANCIER van kunststof en aluminium kozijnen voor aannemers, bouwbedrijven en timmerbedrijven. Kunststofkozijnnodig.nl meet NIET in en plaatst NIET zelf — dat doet de klant. Kunststof A-merken: Aluplast, Gealan, Schüco. Aluminium: Reynaers, Cortizo, Aliplast, Aluprof.
