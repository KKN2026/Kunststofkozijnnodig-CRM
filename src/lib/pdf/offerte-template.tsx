        ...
        <Page size="A4" style={[s.page, { paddingTop: 24, paddingBottom: 24, paddingLeft: 28, paddingRight: 28, backgroundColor: '#FFFFFF' }]}>
          ...
          <View style={{ borderTopWidth: 0.5, borderTopColor: '#D1D5DB', paddingTop: 8 }}>
            <Text style={{ fontSize: 7.5, color: COLORS.green, lineHeight: 1.5, fontStyle: 'italic' }}>
              Op deze offerte en de uiteindelijke overeenkomst zijn de Algemene Voorwaarden van Kunststofkozijnnodig.nl van toepassing. Deze zijn met de offerte aan u toegezonden alsmede te vinden op www.kunststofkozijnnodig.nl/algemene-voorwaarden.
            </Text>
          </View>
